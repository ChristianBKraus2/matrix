...
**[DEFERRED]** — Layer-inversion refactoring not in scope for this session.
...
**[DEFERRED]** — IC direct mutation of GameContext not refactored; out of scope for this session.
...
**[DEFERRED]** — `Decker` entity SRP refactoring not in scope for this session.
...
**[DEFERRED]** — `GameContext` responsibility split not in scope for this session.
...
**[DEFERRED]** — File-splitting refactoring not in scope for this session.
...
**[DEFERRED]** — `LocateResult` generic typing not in scope for this session.
...
**[DEFERRED]** — Alert ordering not moved to `AlertStatus` enum; out of scope for this session.
...
**[DEFERRED]** — `MatrixLocation.withUpdatedTally` encapsulation not in scope for this session.
...
**[DEFERRED]** — Initiative list stale-entry issue not in scope for this session.
