# A2A + LangGraph Agent — Code Review Checklist
...
- [ ] Logging and observability cover both protocol-level events (task state transitions) and security-relevant events (auth failures, rejected AgentCards)
